...
public class exerciseFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerViewExercise = getView().findViewById(R.id.recyclerViewExercise);
        REAdapter_Exercise adapter = new REAdapter_Exercise(getActivity(), exerciseArrayList);
