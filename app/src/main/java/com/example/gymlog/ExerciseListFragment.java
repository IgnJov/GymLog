...
public class ExerciseListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Get elements
        RecyclerView recyclerView_exercise = view.findViewById(R.id.recyclerView_exercise);
        FloatingActionButton floatingActionButton_addExercise = view.findViewById(R.id.floatingActionButton_addExercise);
        ...
        floatingActionButton_addExercise.setOnClickListener(new View.OnClickListener() {
            @Override
